public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println(((14 / 2 + 3) * 0.8509035245341184 + 2) - 125);
        System.out.println(((7 + 3) * 0.8509035245341184 + 2) - 125);
        System.out.println((10 * 0.8509035245341184 + 2) - 125);
        System.out.println((8.50903524534 + 2) - 125);
        System.out.println(10.509035245341185 - 125);
        System.out.println(-114.49096475465882);

        /*I used a long decimal for Math.sin(45) because if it was cut short
        to 0 then the values would be wrong for the rest of the equation simplification
         */
